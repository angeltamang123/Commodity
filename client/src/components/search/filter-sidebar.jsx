    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <Button
          ...
          className="inline-flex bg-[#AF0000] hover:bg-[#730000] items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary-foreground h-10 px-4 py-2 w-full"
        >
          Apply Filters
        </Button>
      </CardContent>
