      ...
      <Card className="w-full max-w-lg shadow-lg">
        ...
        <CardContent>
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4 border p-4 rounded-md">
              ...
              {formik.values.hasDiscount && (
                <>
                  ...
                  <div>
                    <Label htmlFor="discountTill">Discount Till</Label>
                    <Popover>
            ...
            <div>
              <Label htmlFor="mainImagePond">
                Main Product Image (Compulsory)
              </Label>
              <FilePond
            ...
            <div>
              <Label htmlFor="additionalImagesPond">
                Additional Product Images (Optional, Max 5)
              </Label>
              <FilePond
